...
export default function Rightside({ selectedDataset }) {
    ...
    const handleTrain = async () => {
        if (selectedModel === 'DCGAN') {
            ...
            try {
                const res = await axios.post('http://15.206.94.196:5000/train', {
                    num_epochs,
                    lr: learningRate,
                    nz: noiseDim,
            ...
            try {
                const res = await axios.post('http://15.206.94.196:5000/train_wgan_gp', {
                    num_epochs,
                    lr: learningRate,
                    nz: noiseDim,
                    dataroot: selectedDataset,
            ...
            try {
                const res = await axios.post('http://15.206.94.196:5000/train_wgan', {
                    num_epochs,
                    lr: learningRate,
                    nz: noiseDim,
                    dataroot: selectedDataset,
